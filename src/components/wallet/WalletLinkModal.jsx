...
const WalletLinkModal = ({ isOpen, onClose, onLinked }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-[#393E46] rounded-lg shadow-xl max-w-md w-full mx-4 border border-[#4b5563]">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-[#4b5563]">
          <h2 className="text-xl font-bold text-white">Link Wallet</h2>
          <button
            onClick={handleClose}
        ...
        <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center gap-3 p-4 bg-[#222831] border border-[#4b5563] rounded-lg hover:border-[#00ADB5] transition-colors disabled:opacity-50"
                >
                ...
                >
                  <FaWallet className="w-6 h-6 text-[#00ADB5]" />
                  <div className="flex-1 text-left">
                    <div className="text-white font-semibold">Trust Wallet</div>
                    <div className="text-gray-400 text-sm">Connect with Trust Wallet</div>
                  </div>
                </button>
              </div>
            </div>
          ...
          {step === 2 && signatureMessage && (
            <div className="space-y-4">
              <div className="bg-[#222831] rounded-lg p-4 border border-[#4b5563]">
                <p className="text-gray-300 text-sm mb-2">Sign this message to verify wallet ownership:</p>
                <div className="bg-[#393E46] rounded p-3 text-xs text-gray-400 font-mono break-all">
          ...
          {step === 3 && (
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Wallet Linked Successfully!</h3>
