...
const NotificationDropdown = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 bg-[var(--card-bg)] border border-[var(--border-color)] rounded-lg shadow-xl z-50 max-h-96 overflow-hidden flex flex-col">
          {/* Header */}
                ...
                {notifications.slice(0, 10).map((notification) => (
                  <div
                    ...
                    className={`p-4 hover:bg-[var(--bg-hover)] transition-colors cursor-pointer ${
                      !notification.read ? 'bg-[var(--bg-hover)]/50' : ''
                    }`}
                    onClick={() => {
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[var(--text-secondary)] text-xs mt-1">{notification.message}</p>
